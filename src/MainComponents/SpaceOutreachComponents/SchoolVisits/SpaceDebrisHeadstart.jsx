...
const SpaceDebrisHeadstart = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Debris Headstart Activity 1' },
    { src: activity2, alt: 'Space Debris Headstart Activity 2' },
    { src: activity3, alt: 'Space Debris Headstart Activity 3' }
  ];
...
export default SpaceDebrisHeadstart;

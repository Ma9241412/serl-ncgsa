...
const InventixSummit = () => {
  const heroImages = [
    { src: activity1, alt: 'Inventix Summit Activity 1' },
    { src: activity2, alt: 'Inventix Summit Activity 2' },
    { src: activity3, alt: 'Inventix Summit Activity 3' }
  ];

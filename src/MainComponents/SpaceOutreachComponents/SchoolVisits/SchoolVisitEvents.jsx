...
const SchoolVisitEvents = () => {
  const heroImages = [
    { src: activity1, alt: 'School Visit Events Activity 1' },
    { src: activity2, alt: 'School Visit Events Activity 2' },
    { src: activity3, alt: 'School Visit Events Activity 3' }
...
export default SchoolVisitEvents;

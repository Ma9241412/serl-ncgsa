...
const SpaceSciCommCaseStudy = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Sci Comm Case Study Activity 1' },
    { src: activity2, alt: 'Space Sci Comm Case Study Activity 2' },
    { src: activity3, alt: 'Space Sci Comm Case Study Activity 3' }
  ];
...
export default SpaceSciCommCaseStudy;

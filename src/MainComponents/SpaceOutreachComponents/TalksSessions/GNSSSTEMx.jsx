...
const GNSSSTEMx = () => {
  const heroImages = [
    { src: activity1, alt: 'GNSS STEMx Activity 1' },
    { src: activity2, alt: 'GNSS STEMx Activity 2' },
    { src: activity3, alt: 'GNSS STEMx Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          Global Navigation Satellite Systems -STEMx
        </Title>

...
const SpaceTalkRezaShirazi = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Talk Reza Shirazi Activity 1' },
    { src: activity2, alt: 'Space Talk Reza Shirazi Activity 2' },
    { src: activity3, alt: 'Space Talk Reza Shirazi Activity 3' }
  ];
    ...
    <>
      ...
      <Card className="soc-card">
        <Title level={3} className="soc-title-3">
          Space Technology Education and Popularization - 60 Minutes Talk with Reza Shirazi
        </Title>
...
export default SpaceTalkRezaShirazi;
...
const CareersInSpace = () => {
  const heroImages = [
    { src: activity1, alt: 'Careers in Space Activity 1' },
    { src: activity2, alt: 'Careers in Space Activity 2' },
    { src: activity3, alt: 'Careers in Space Activity 3' }
  ];

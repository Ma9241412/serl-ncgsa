...
const SpaceTechEduLandscape = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Tech Edu Landscape Activity 1' },
    { src: activity2, alt: 'Space Tech Edu Landscape Activity 2' },
    { src: activity3, alt: 'Space Tech Edu Landscape Activity 3' }
  ];
...
export default SpaceTechEduLandscape;

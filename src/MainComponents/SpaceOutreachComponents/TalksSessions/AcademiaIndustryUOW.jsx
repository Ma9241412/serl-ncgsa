...
const AcademiaIndustryUOW = () => {
  const heroImages = [
    { src: activity1, alt: 'Academia Industry UOW Activity 1' },
    { src: activity2, alt: 'Academia Industry UOW Activity 2' },
    { src: activity3, alt: 'Academia Industry UOW Activity 3' }
  ];
...
export default AcademiaIndustryUOW;

...
const TechNexusSecurity = () => {
  const heroImages = [
    { src: activity1, alt: 'Tech Nexus Security Activity 1' },
    { src: activity2, alt: 'Tech Nexus Security Activity 2' },
    { src: activity3, alt: 'Tech Nexus Security Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          Space and Technology Nexus: Boosting National Security & Economic Prosperity
        </Title>
...
export default TechNexusSecurity;

...
const WomenInSpaceSector = () => {
  const heroImages = [
    { src: activity1, alt: 'Women in Space Sector Activity 1' },
    { src: activity2, alt: 'Women in Space Sector Activity 2' },
    { src: activity3, alt: 'Women in Space Sector Activity 3' }
  ];
    ...
    <>
      ...
      <Card className="soc-card">
        <Title level={3} className="soc-title-3">
          Space For All: Women in Space Sector
        </Title>
...
export default WomenInSpaceSector;

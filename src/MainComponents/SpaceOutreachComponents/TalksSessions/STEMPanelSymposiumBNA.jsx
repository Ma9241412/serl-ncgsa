...
const STEMPanelSymposiumBNA = () => {
  const heroImages = [
    { src: activity1, alt: 'STEM Panel Symposium BNA Activity 1' },
    { src: activity2, alt: 'STEM Panel Symposium BNA Activity 2' },
    { src: activity3, alt: 'STEM Panel Symposium BNA Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          STEM Panel in Symposium of Innovation (BNA)
        </Title>
...
export default STEMPanelSymposiumBNA;

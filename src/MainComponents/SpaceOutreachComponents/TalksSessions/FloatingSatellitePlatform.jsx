...
const FloatingSatellitePlatform = () => {
  const heroImages = [
    { src: activity1, alt: 'Floating Satellite Platform Activity 1' },
    { src: activity2, alt: 'Floating Satellite Platform Activity 2' },
    { src: activity3, alt: 'Floating Satellite Platform Activity 3' }
  ];
...
export default FloatingSatellitePlatform;

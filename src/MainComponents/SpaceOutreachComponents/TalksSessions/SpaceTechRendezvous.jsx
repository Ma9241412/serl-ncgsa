...
const SpaceTechRendezvous = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Tech Rendezvous Activity 1' },
    { src: activity2, alt: 'Space Tech Rendezvous Activity 2' },
    { src: activity3, alt: 'Space Tech Rendezvous Activity 3' }
  ];
...
export default SpaceTechRendezvous;

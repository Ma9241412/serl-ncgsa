...
const WomenInSpaceContributions = () => {
  const heroImages = [
    { src: activity1, alt: 'Women in Space Contributions Activity 1' },
    { src: activity2, alt: 'Women in Space Contributions Activity 2' },
    { src: activity3, alt: 'Women in Space Contributions Activity 3' }
  ];
...
export default WomenInSpaceContributions;

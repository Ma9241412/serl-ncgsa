...
const STEMforSpaceVU = () => {
  const heroImages = [
    { src: activity1, alt: 'STEM for Space VU Activity 1' },
    { src: activity2, alt: 'STEM for Space VU Activity 2' },
    { src: activity3, alt: 'STEM for Space VU Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
         STEM for Space Technology- National conference on STEM at COMSTECH by VU
        </Title>

...
const SpaceTechSDGs = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Tech SDGs Activity 1' },
    { src: activity2, alt: 'Space Tech SDGs Activity 2' },
    { src: activity3, alt: 'Space Tech SDGs Activity 3' }
  ];

...
const IACBakuResearch = () => {
  const heroImages = [
    { src: activity1, alt: 'IAC Baku Research Activity 1' },
    { src: activity2, alt: 'IAC Baku Research Activity 2' },
    { src: activity3, alt: 'IAC Baku Research Activity 3' }
  ];
...
export default IACBakuResearch;

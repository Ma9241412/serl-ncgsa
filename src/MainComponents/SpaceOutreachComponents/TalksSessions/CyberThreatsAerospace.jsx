...
const CyberThreatsAerospace = () => {
  const heroImages = [
    { src: activity1, alt: 'Cyber Threats Aerospace Activity 1' },
    { src: activity2, alt: 'Cyber Threats Aerospace Activity 2' },
    { src: activity3, alt: 'Cyber Threats Aerospace Activity 3' }
  ];
...
export default CyberThreatsAerospace;

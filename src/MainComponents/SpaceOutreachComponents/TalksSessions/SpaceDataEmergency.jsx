...
const SpaceDataEmergency = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Data Emergency Activity 1' },
    { src: activity2, alt: 'Space Data Emergency Activity 2' },
    { src: activity3, alt: 'Space Data Emergency Activity 3' }
  ];
...
export default SpaceDataEmergency;

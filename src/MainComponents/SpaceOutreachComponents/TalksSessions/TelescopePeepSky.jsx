...
const TelescopePeepSky = () => {
  const heroImages = [
    { src: activity1, alt: 'Telescope Peep Sky Activity 1' },
    { src: activity2, alt: 'Telescope Peep Sky Activity 2' },
    { src: activity3, alt: 'Telescope Peep Sky Activity 3' }
  ];
...
export default TelescopePeepSky;

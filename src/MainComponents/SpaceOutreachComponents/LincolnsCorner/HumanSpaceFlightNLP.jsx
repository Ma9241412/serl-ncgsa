...
const HumanSpaceFlightNLP = () => {
  const heroImages = [
    { src: activity1, alt: 'Human Spaceflight NLP Activity 1' },
    { src: activity2, alt: 'Human Spaceflight NLP Activity 2' },
    { src: activity3, alt: 'Human Spaceflight NLP Activity 3' }
  ];
...
export default HumanSpaceFlightNLP;

...
import { Row, Col, Typography, Card, Select, Collapse } from 'antd';
...
const SpaceOutreachSection = () => {
  ...
  const programData = {
    ...
    'space-festivals': {
      ...
      events: ['lahore-science-mela', 'steam-mela', 'space-expo', 'pakistan-learning-festival']
    },
    'space-media': {
      title: 'Space Media',
    ...
    'lincolns-corner': {
      ...
      events: ['human-spaceflight-fjwu', 'human-spaceflight-nlp', 'women-in-space-fjwu', 'wright-brothers-day-fjwu']
    },
    'astronomy-outreach': {
    ...
    'talks-sessions': {
      ...
      events: ['stemx-webinar', 'the-space-talk-podcast', 'space-tech-edu-landscape', 'cyber-threats-aerospace', 'space-data-emergency', 'tech-nexus-security', 'stem-for-space-vu', 'space-tech-sdgs', 'women-in-space-contributions', 'women-in-space-sector', 'floating-satellite-platform', 'careers-in-space', 'telescope-peep-sky', 'stem-panel-symposium-bna', 'academia-industry-uow', 'iac-baku-research', 'ai-future-panel-nust', 'space-sci-comm-case-study', 'space-talk-reza-shirazi', 'gnss-stemx', 'space-tech-rendezvous']
    },
    'hosting-visits': {
      title: 'Hosting Visits',
      events: ['hec', 'hosting-visits-list', 'lt-gen-mohsin-qureshi', 'nastp', 'pak-china-research-center', 'prof-ahsan-iqbal']
    },
    'showcasing': {
      title: 'Showcasing',
    ...
    'forum': {
      title: 'Forum',
      events: ['space-forum-2020', 'space-forum-2021', 'careers-in-space-forum', 'step-forum', 'forum-360-stem', 'space-forum-2022']
    }
  };

  // State management with defaults
  const [selectedProgram, setSelectedProgram] = useState('world-space-week');
  const [selectedYear, setSelectedYear] = useState(programData['world-space-week'].years[0]); // For World Space Week

...
const JahanAurBhiHain = () => {
  const heroImages = [
    { src: activity1, alt: 'Jahan Aur Bhi Hain Activity 1' },
    { src: activity2, alt: 'Jahan Aur Bhi Hain Activity 2' },
    { src: activity3, alt: 'Jahan Aur Bhi Hain Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'Educational Programs On The Search For Extraterrestrial Intelligence And Life',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'Documentary Productions Exploring Astrobiology And Space Science Concepts',
      icon: <BookOutlined />
    },
    {
      title: 'Public Lectures And Discussions On The Possibility Of Life Beyond Earth',
      icon: <StarOutlined />
    },
    {
      title: 'Interactive Workshops On Radio Astronomy And SETI Research Methods',
    ...
    <>
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          "Jahan Aur Bhi Hain" (There Are Other Worlds) is SERL's flagship media initiative that explores the possibility of life beyond Earth and engages Pakistani audiences with the fascinating search for extraterrestrial intelligence.
        </Text>
      </Card>
...
export default JahanAurBhiHain;

...
const SpaceExpo = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Expo Activity 1' },
    { src: activity2, alt: 'Space Expo Activity 2' },
    { src: activity3, alt: 'Space Expo Activity 3' }
  ];
    ...
    <>
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          SERL organizes comprehensive Space Expos featuring cutting-edge space technology, research innovations, and educational programs designed to showcase Pakistan's growing capabilities in space science.
        </Text>
      </Card>

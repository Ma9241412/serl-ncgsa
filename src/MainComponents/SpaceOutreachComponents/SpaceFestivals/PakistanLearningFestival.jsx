...
const PakistanLearningFestival = () => {
  const heroImages = [
    { src: activity1, alt: 'Pakistan Learning Festival Activity 1' },
    { src: activity2, alt: 'Pakistan Learning Festival Activity 2' },
    { src: activity3, alt: 'Pakistan Learning Festival Activity 3' }
  ];
  ...
  return (
    <>
      {/* Pakistan Learning Festival Section */}
      <Card
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          SERL proudly participates in the Pakistan Learning Festival, contributing to national education initiatives by promoting space science education and inspiring Pakistani youth to pursue careers in STEM fields.
        </Text>
      </Card>
...
export default PakistanLearningFestival;

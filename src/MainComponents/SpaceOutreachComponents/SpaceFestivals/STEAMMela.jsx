...
const STEAMMela = () => {
  const heroImages = [
    { src: activity1, alt: 'STEAM Mela Activity 1' },
    { src: activity2, alt: 'STEAM Mela Activity 2' },
    { src: activity3, alt: 'STEAM Mela Activity 3' }
  ];
    ...
    <>
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          SERL contributes to STEAM (Science, Technology, Engineering, Arts, and Mathematics) Mela by integrating space science with creative learning approaches, making education more engaging and accessible.
        </Text>
      </Card>

...
const SolarTelescopyVisits = () => {
  const heroImages = [
    { src: activity1, alt: 'Solar Telescopy Activity 1' },
    { src: activity2, alt: 'Solar Telescopy Activity 2' },
    { src: activity3, alt: 'Solar Telescopy Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'Safe Solar Observation Sessions Using Professional Solar Telescopes',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'Educational Workshops On Solar Physics And Helioseismology',
      icon: <BookOutlined />
    },
    {
      title: 'Hands-On Training With Solar Filters And Observation Equipment',
      icon: <StarOutlined />
    },
    {
      title: 'Data Collection And Analysis Of Solar Activity And Phenomena',
  ...
  return (
    <>
      {/* Solar Telescopy Visits Section */}
      <Card
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          SERL's Solar Telescopy Program Provides Students And Visitors With Safe, Professional Solar Observation Experiences, Teaching Solar Physics And Astronomy Through Direct Observation.
        </Text>
      </Card>
...
export default SolarTelescopyVisits;

...
const VCForum2023 = () => {
  const heroImages = [
    { src: activity1, alt: 'VC Forum 2023 Activity 1' },
    { src: activity2, alt: 'VC Forum 2023 Activity 2' },
    { src: activity3, alt: 'VC Forum 2023 Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          5th Vice Chancellors Forum 2023 of Universities in the Islamic World, themed 'Towards Disruptive Technology in a Globalized World' ICESCO
        </Title>

...
const Beaconhouse = () => {
  const heroImages = [
    { src: activity1, alt: 'Beaconhouse Activity 1' },
    { src: activity2, alt: 'Beaconhouse Activity 2' },
    { src: activity3, alt: 'Beaconhouse Activity 3' }
  ];

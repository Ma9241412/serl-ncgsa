...
const WorldSpaceWeek2022 = () => {
  ...
  const activities = [
    {
      title: 'Expert Talks And Seminars On Using Space Technology For Sustainability',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'Environmental-Themed Competitions For Schools And Youth Groups',
      icon: <BookOutlined />
    },
    {
      title: 'Stargazing Events And Satellite Tracking Sessions With Eco-Focused Insights',
      icon: <StarOutlined />
    },
    {
      title: 'Workshops And Projects Exploring Green Tech In Space Missions',
    ...
    <>
      ...
      >
        ...
        <Text style={{ color: '#cccccc', fontSize: '18px' }}>
          The 2022 Theme "Space and Sustainability" Focuses On The Role Of Space Technology In Achieving Sustainable Development Goals. Exploring How Space Science Contributes To Environmental Monitoring And Climate Action.
        </Text>
      </Card>
...
export default WorldSpaceWeek2022;

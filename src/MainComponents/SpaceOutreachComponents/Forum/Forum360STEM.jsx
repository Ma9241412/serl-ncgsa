...
const Forum360STEM = () => {
  const heroImages = [
    { src: activity1, alt: 'Forum 360 STEM Activity 1' },
    { src: activity2, alt: 'Forum 360 STEM Activity 2' },
    { src: activity3, alt: 'Forum 360 STEM Activity 3' }
  ];

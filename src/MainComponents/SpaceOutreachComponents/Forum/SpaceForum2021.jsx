...
const SpaceForum2021 = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Forum 2021 Activity 1' },
    { src: activity2, alt: 'Space Forum 2021 Activity 2' },
    { src: activity3, alt: 'Space Forum 2021 Activity 3' }
  ];

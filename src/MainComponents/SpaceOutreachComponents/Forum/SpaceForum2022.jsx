...
const SpaceForum2022 = () => {
  const heroImages = [
    { src: activity1, alt: 'Space Forum 2022 Activity 1' },
    { src: activity2, alt: 'Space Forum 2022 Activity 2' },
    { src: activity3, alt: 'Space Forum 2022 Activity 3' }
  ];

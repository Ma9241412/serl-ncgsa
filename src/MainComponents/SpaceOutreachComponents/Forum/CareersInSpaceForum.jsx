...
const CareersInSpaceForum = () => {
  const heroImages = [
    { src: activity1, alt: 'Careers in Space Forum Activity 1' },
    { src: activity2, alt: 'Careers in Space Forum Activity 2' },
    { src: activity3, alt: 'Careers in Space Forum Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'Career Guidance Sessions With Space Industry Professionals And Executives',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'Networking Opportunities With Space Organizations And Research Institutions',
      icon: <BookOutlined />
    },
    {
      title: 'Workshops On Resume Building And Interview Skills For Space Careers',
      icon: <StarOutlined />
    },
    {
      title: 'Panel Discussions On Diverse Career Paths In Space Science And Technology',
  ...
  return (
    <>
      {/* Careers in Space Forum Section */}
      <Card className="soc-card">
        <Title level={3} className="soc-title-3">
          Meet The Scientists Forum (Careers in Space)
        </Title>
...
export default CareersInSpaceForum;

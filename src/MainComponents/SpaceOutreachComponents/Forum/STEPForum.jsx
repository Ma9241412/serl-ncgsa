...
const STEPForum = () => {
  const heroImages = [
    { src: activity1, alt: 'STEP Forum Activity 1' },
    { src: activity2, alt: 'STEP Forum Activity 2' },
    { src: activity3, alt: 'STEP Forum Activity 3' }
  ];

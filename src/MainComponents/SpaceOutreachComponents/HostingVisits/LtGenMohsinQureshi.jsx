...
const LtGenMohsinQureshi = () => {
  const heroImages = [
    { src: activity1, alt: 'Lt Gen Mohsin Qureshi Activity 1' },
    { src: activity2, alt: 'Lt Gen Mohsin Qureshi Activity 2' },
    { src: activity3, alt: 'Lt Gen Mohsin Qureshi Activity 3' }
  ];
...
export default LtGenMohsinQureshi;

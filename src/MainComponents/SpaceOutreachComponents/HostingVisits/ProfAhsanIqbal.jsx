...
const ProfAhsanIqbal = () => {
  const heroImages = [
    { src: activity1, alt: 'Prof. Ahsan Iqbal Visit Activity 1' },
    { src: activity2, alt: 'Prof. Ahsan Iqbal Visit Activity 2' },
    { src: activity3, alt: 'Prof. Ahsan Iqbal Visit Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'Prof. Ahsan Iqbal Visit: Public Lectures And Seminars Featuring Leading Space Scientists And Researchers',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'Prof. Ahsan Iqbal Visit: School Competitions And Activities Designed To Engage Students With Space Science',
      icon: <BookOutlined />
    },
    {
      title: 'Prof. Ahsan Iqbal Visit: Astronomy Observation Sessions With Professional Telescopes And Expert Guidance',
      icon: <StarOutlined />
    },
    {
      title: 'Prof. Ahsan Iqbal Visit: Workshops And Hands-On Activities Exploring Space Technology And Principles',

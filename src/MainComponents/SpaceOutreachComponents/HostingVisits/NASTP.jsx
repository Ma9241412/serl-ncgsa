...
const NASTP = () => {
  const heroImages = [
    { src: activity1, alt: 'NASTP Activity 1' },
    { src: activity2, alt: 'NASTP Activity 2' },
    { src: activity3, alt: 'NASTP Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          National Aerospace Science and Technology Park (NASTP) Visit
        </Title>

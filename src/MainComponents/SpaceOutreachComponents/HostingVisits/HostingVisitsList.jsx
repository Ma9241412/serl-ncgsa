...
const HostingVisitsList = () => {
  const heroImages = [
    { src: activity1, alt: 'Hosting Visits List Activity 1' },
    { src: activity2, alt: 'Hosting Visits List Activity 2' },
    { src: activity3, alt: 'Hosting Visits List Activity 3' }
  ];
...
export default HostingVisitsList;

...
const NationalAerospaceScienceAndTechnologyParkNASTPD12 = () => {
  // ...existing code...
  return (
    <>
      <Card style={{ backgroundColor: '#2a2a2a', border: 'none', borderRadius: '20px' }} bodyStyle={{ padding: '24px', backgroundColor: '#2a2a2a', borderRadius: '20px' }}>
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          National Aerospace Science and Technology Park (NASTP) +D12
        </Title>
        {/* ...existing code... */}
      </Card>
    </>
...
export default NationalAerospaceScienceAndTechnologyParkNASTPD12;

...
const HEC = () => {
  const heroImages = [
    { src: activity1, alt: 'HEC Visit Activity 1' },
    { src: activity2, alt: 'HEC Visit Activity 2' },
    { src: activity3, alt: 'HEC Visit Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'HEC Delegation Visit: Public Lectures And Seminars Featuring Leading Space Scientists And Researchers',
      icon: <ClockCircleOutlined />
    },
    {
      title: 'HEC Delegation Visit: School Competitions And Activities Designed To Engage Students With Space Science',
      icon: <BookOutlined />
    },
    {
      title: 'HEC Delegation Visit: Astronomy Observation Sessions With Professional Telescopes And Expert Guidance',
      icon: <StarOutlined />
    },
    {
      title: 'HEC Delegation Visit: Workshops And Hands-On Activities Exploring Space Technology And Principles',

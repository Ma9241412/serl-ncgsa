...
const PakChinaResearchCenter = () => {
  const heroImages = [
    { src: activity1, alt: 'Pak China Research Center Activity 1' },
    { src: activity2, alt: 'Pak China Research Center Activity 2' },
    { src: activity3, alt: 'Pak China Research Center Activity 3' }
  ];
    ...
    <>
      ...
      >
        <Title level={3} style={{ color: 'white', marginBottom: '8px', fontSize: '28px' }}>
          Pak-China Research Center Visit
        </Title>
...
export default PakChinaResearchCenter;

...
const HigherEducationCommission = () => {
  const heroImages = [
    { src: activity1, alt: 'HEC Activity 1' },
    { src: activity2, alt: 'HEC Activity 2' },
    { src: activity3, alt: 'HEC Activity 3' }
  ];
  ...
  const activities = [
    {
      title: 'Collaborative Research Initiatives in Space Science and Technology',
      icon: <ExperimentOutlined />
    },
    {
      title: 'National Workshops and Seminars for Academic Institutions',
      icon: <BookOutlined />
    },
    {
      title: 'Student Exchange Programs and Scholarships',
      icon: <StarOutlined />
    },
    {
      title: 'Policy Development for Higher Education in Space Sciences',
    ...
    <>
      ...
      <Card className="soc-card">
        ...
        <Text className="soc-text">
          The Higher Education Commission (HEC) plays a pivotal role in advancing space science education and research across Pakistan, fostering academic collaboration and supporting innovative projects in the field.
        </Text>
      </Card>

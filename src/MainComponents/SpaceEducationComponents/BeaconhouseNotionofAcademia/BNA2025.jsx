...
const LtGeneralMohsinQureshi = () => {
  ...
  const activities = [
    {
      title: 'Leadership in Space Science Initiatives',
      icon: <ExperimentOutlined />
    },
    {
      title: 'Strategic Collaborations with Defense and Academic Institutions',
      icon: <BookOutlined />
    },
    {
      title: 'Mentorship Programs for Young Scientists',
      icon: <StarOutlined />
    },
    {
      title: 'Policy Advocacy for National Space Programs',
    ...
    <>
      <Card className="soc-card">
        ...
        <Text className="soc-text">
          Lt. General Mohsin Qureshi has played a key role in advancing Pakistan's space science and technology landscape, fostering strategic partnerships and inspiring future leaders in the field.
        </Text>
      </Card>
...
export default LtGeneralMohsinQureshi;

...
import '../../Styles/AboutContribution.css';
...
const SpaceOutreach = () => {
  ...
  return (
    <Row className="contrib-wrapper" justify="space-between" align="top" gutter={[32, 32]}>
      <Col xs={24} lg={12} className="contrib-text-col">
      ...
      <Col xs={24} lg={11} className="contrib-image-col">

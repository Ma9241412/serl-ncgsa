...
const items = [
  {
    key: '1',
    label: <span className="ttw-label">Grade 1-5 Activity Books</span>,
    children: getPanelContent(),
  },
  {
    key: '2',
    label: <span className="ttw-label">Grade 6-10 Activity Books</span>,
    children: getPanelContent(),
  },
];
...
const mainHeading = (
  <Title level={2} className="cbs-title">
    Space Activity<span className="cbs-title-highlight"> Book Development </span>
  </Title>
);

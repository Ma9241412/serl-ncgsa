...
const items = [
  {
    key: '1',
    label: <Text className="ttw-label">Space Science & Technology Curriculum - Mazen School</Text>,
...
const mainHeading = (
  <Title level={2} className="cbs-title">
    Curriculum Development<Text className="cbs-title-highlight"></Text>
  </Title>
);
...
const CurriculumDevelopment = () => (
  <div className="section-container">
    {mainHeading}
    {mainParagraph}
    <Collapse items={[items[0]]} bordered={false} defaultActiveKey={[]} className="ttw-wrapper" style={collapseStyle} />
  </div>
);

...
const items = [
  {
    key: '1',
    label: <span className="ttw-label">International Workshop on Space Law Policy</span>,
    children: getPanelContent(),
  },
  {
    key: '2',
    label: <span className="ttw-label">National GIS Summit</span>,
    children: getPanelContent(),
  },
];
...
const mainHeading = (
  <Title level={2} className="cbs-title">
    Professionals<span className="cbs-title-highlight"> Training </span>
  </Title>
);
